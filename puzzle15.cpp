...
Puzzle_15::Puzzle_15(const unsigned char permutation[16])
{
    ...
    else
    {
    	...
    	for(unsigned char y=0;y<4;++y){auto tile = (short)permutation[z];
...
unsigned char Puzzle_15::heuristic( )
{
...
inline std::vector<char> Puzzle_15::findPath(std::vector<node> &path, const unsigned char &depth , const unsigned char &bound,
...
/////////////////////////////////////////////////////////////////////////////////////////
/*
inline bool Puzzle_15::not_in_path(unsigned char(*current)[4], std::vector<node> &path)
{
...
inline bool Puzzle_15::same_node(unsigned char(*nodeA)[4], unsigned char(*nodeB)[4])
{
    for(unsigned char x=0;x<4;++x)
    for(unsigned char y=0;y<4;++y)
    {
